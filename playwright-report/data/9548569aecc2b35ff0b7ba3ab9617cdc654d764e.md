...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace toolbar behavior >> Zoom mode uses wheel and Escape cancels
...
Call log:
  ...
  - waiting for getByTestId('plan-transform')
    9 × locator resolved to <div data-plan-zoom="1" data-plan-pan-x="0" data-plan-pan-y="0" class="h-full w-full " data-testid="plan-transform">…</div>
      - unexpected value "1"
...
- generic [ref=e1]:
      ...
      - generic [ref=e39]:
        - generic [ref=e40]:
          ...
          - button "Pan" [ref=e45] [cursor=pointer]:
            - img [ref=e46]
            - generic [ref=e51]: Pan
          - button "Zoom" [active] [ref=e52] [cursor=pointer]:
            - img [ref=e53]
  ...
  - contentinfo [ref=e928]:
    - generic [ref=e929]: Zoom active. Scroll wheel over the plan to zoom in/out. Press Esc for Select.
