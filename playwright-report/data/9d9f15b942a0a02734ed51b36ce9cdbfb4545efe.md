...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Photo is pressable without crashing
...
- generic [ref=e1]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e120]:
        - generic [ref=e121]:
          ...
          - button "Photo" [active] [ref=e127] [cursor=pointer]:
            - img [ref=e128]
  ...
  - generic [ref=e930]:
    - generic [ref=e931]:
      - generic [ref=e932]:
        - generic [ref=e933]: Add Photo
        - heading "Add or choose site photo" [level=2] [ref=e934]
      - button [ref=e935] [cursor=pointer]:
        - img [ref=e936]
    - generic [ref=e940]:
      - generic [ref=e941]:
        - generic [ref=e942]: Upload placeholder
        - paragraph [ref=e943]: In the Supabase version this becomes a real upload into a site-visit folder. For now, enter a file name or choose an existing photo below.
        - 'textbox "Example: FIELD_B18_CLOSEUP.jpg" [ref=e944]'
        - button "Add Photo To Selected Item" [ref=e945] [cursor=pointer]
      - generic [ref=e946]:
        - button "P101_0456.JPG" [ref=e947] [cursor=pointer]:
          - img [ref=e949]
          - generic [ref=e966]: P101_0456.JPG
        - button "P101_0461.JPG" [ref=e967] [cursor=pointer]:
          - img [ref=e969]
          - generic [ref=e986]: P101_0461.JPG
        - button "P101_0468.JPG" [ref=e987] [cursor=pointer]:
          - img [ref=e989]
          - generic [ref=e1006]: P101_0468.JPG
        - button "P101_0457.JPG" [ref=e1007] [cursor=pointer]:
          - img [ref=e1009]
          - generic [ref=e1026]: P101_0457.JPG
        - button "P101_0458.JPG" [ref=e1027] [cursor=pointer]:
          - img [ref=e1029]
          - generic [ref=e1046]: P101_0458.JPG
  - contentinfo [ref=e1047]:
    - generic [ref=e1048]: Photo tool active. Choose or add a site photo from the photo picker.
    - generic [ref=e1049]: "X: 152'-3 1/2\" Y: 47'-6 3/4\" | Plan: 100% / Map: 100% | Grid: 1'-0\" ● Online"
```
