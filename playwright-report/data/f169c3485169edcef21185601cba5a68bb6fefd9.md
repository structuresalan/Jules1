...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Zoom Area is pressable without crashing
      ...
      - generic [ref=e39]:
        - generic [ref=e40]:
          ...
          - button "Fit" [ref=e57] [cursor=pointer]:
            - img [ref=e58]
            - generic [ref=e63]: Fit
          - button "Zoom Area" [active] [ref=e64] [cursor=pointer]:
            - img [ref=e65]
