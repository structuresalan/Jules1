...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> workspace button Workspace is pressable without crashing
...
- generic [ref=e1]:
  - banner [ref=e2]:
    - generic [ref=e3]:
      ...
      - navigation [ref=e11]:
        - button "Workspace" [active] [ref=e12] [cursor=pointer]
