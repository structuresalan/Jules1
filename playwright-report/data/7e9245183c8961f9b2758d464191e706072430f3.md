...
- Location: tests\visual-workspace-tools.spec.ts:131:3
...
Call log:
  ...
  - waiting for getByTestId('plan-transform')
    9 × locator resolved to <div data-plan-zoom="1" data-plan-pan-x="0" data-plan-pan-y="0" class="h-full w-full " data-active-tool="Zoom" data-testid="plan-transform">…</div>
      - unexpected value "1"
...
- generic [ref=e1]:
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Zoom active. Scroll wheel over the plan to zoom in/out. Press Esc for Select.
