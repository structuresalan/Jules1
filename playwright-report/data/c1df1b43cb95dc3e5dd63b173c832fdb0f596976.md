...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace toolbar behavior >> Select only selects an annotation and does not move it on click
- Location: tests\visual-workspace-tools.spec.ts:34:3
