...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace toolbar behavior >> Escape cancels active tool back to Select
- Location: tests\visual-workspace-tools.spec.ts:88:3
