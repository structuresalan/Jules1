...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button File is pressable without crashing
...
- generic [ref=e1]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e120]:
        - generic [ref=e121]:
          ...
          - button "File" [active] [ref=e132] [cursor=pointer]:
            - img [ref=e133]
  ...
  - generic [ref=e930]:
    - generic [ref=e931]:
      - generic [ref=e932]:
        - generic [ref=e933]: Attach File
        - heading "Attach document to selected item" [level=2] [ref=e934]
      - button [ref=e935] [cursor=pointer]:
        - img [ref=e936]
    - generic [ref=e940]:
      - paragraph [ref=e941]: Attach a document reference to the selected item. Real file upload will use Supabase Storage.
      - button "Attach Demo File" [ref=e942] [cursor=pointer]
  - contentinfo [ref=e943]:
    - generic [ref=e944]: File tool active. Use the board canvas to place or edit this markup.
    - generic [ref=e945]: "X: 152'-3 1/2\" Y: 47'-6 3/4\" | Plan: 100% / Map: 100% | Grid: 1'-0\" ● Online"
```
