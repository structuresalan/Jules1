...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> workspace button Report is pressable without crashing
...
- generic [ref=e1]:
  - banner [ref=e2]:
    - generic [ref=e3]:
      ...
      - navigation [ref=e11]:
        ...
        - button "Report" [active] [ref=e14] [cursor=pointer]
  ...
  - generic [ref=e934]:
    - generic [ref=e935]:
      - generic [ref=e936]:
        - generic [ref=e937]: Report Builder
        - heading "Generate structural inspection report" [level=2] [ref=e938]
      - button [ref=e939] [cursor=pointer]:
        - img [ref=e940]
    - generic [ref=e944]:
      - paragraph [ref=e945]: Create a report using selected items, photos, comments, issue details, and the markup schedule.
      - generic [ref=e946]:
        - button "Export Word Draft" [ref=e947] [cursor=pointer]
        - button "Export PDF Text Draft" [ref=e948] [cursor=pointer]
  - contentinfo [ref=e949]:
    - generic [ref=e950]: Select active. Click a markup to select it and show properties. Use Eraser to delete, Pan to move the view, Esc cancels active tools.
    - generic [ref=e951]: "X: 152'-3 1/2\" Y: 47'-6 3/4\" | Plan: 100% / Map: 100% | Grid: 1'-0\" ● Online"
```
