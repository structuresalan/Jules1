...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace toolbar behavior >> Photo, File, and Note tools open their panels
- Location: tests\visual-workspace-tools.spec.ts:138:3
