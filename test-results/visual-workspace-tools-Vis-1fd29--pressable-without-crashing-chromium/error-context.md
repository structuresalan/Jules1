...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Cloud is pressable without crashing
...
- generic [ref=e1]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e70]:
        - generic [ref=e71]:
          ...
          - button "Cloud" [active] [ref=e76] [cursor=pointer]:
            - img [ref=e77]
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Cloud tool active. Drag around a region to create a review cloud linked to the selected item.
