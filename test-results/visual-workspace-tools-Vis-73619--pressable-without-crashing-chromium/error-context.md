...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Dimension is pressable without crashing
...
- generic [ref=e1]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e70]:
        - generic [ref=e71]:
          ...
          - button "Dimension" [active] [ref=e92] [cursor=pointer]:
            - img [ref=e93]
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Dimension tool active. Pick points on the board to record measurement markup.
