...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> workspace button Add board is pressable without crashing
...
- generic [ref=e1]:
    ...
    - complementary [ref=e213]:
      ...
      - generic [ref=e223]:
        - generic [ref=e224]:
          ...
          - button "Add board" [active] [ref=e226] [cursor=pointer]:
            - img [ref=e227]
        - generic [ref=e228]:
          - img [ref=e229]
          - textbox [ref=e232]:
  ...
  - generic [ref=e934]:
    - generic [ref=e935]:
      - generic [ref=e936]:
        - generic [ref=e937]: Workspace Settings
        - heading "Workspace settings" [level=2] [ref=e938]
      - button [ref=e939] [cursor=pointer]:
        - img [ref=e940]
    - generic [ref=e944]:
      - generic [ref=e945]:
        - generic [ref=e946]: Current role
        - paragraph [ref=e947]: Engineer can edit everything. Client can comment only.
        - combobox [ref=e948]:
          - option "Engineer" [selected]
          - option "Client"
      - generic [ref=e949]:
        - button "Attach Demo Photo" [ref=e950] [cursor=pointer]
        - button "Attach Demo Document" [ref=e951] [cursor=pointer]
        - button "Reset Demo Data" [ref=e952] [cursor=pointer]
        - button "Close" [ref=e953] [cursor=pointer]
  - contentinfo [ref=e954]:
    - generic [ref=e955]: Select active. Click a markup to select it and show properties. Use Eraser to delete, Pan to move the view, Esc cancels active tools.
    - generic [ref=e956]: "X: 152'-3 1/2\" Y: 47'-6 3/4\" | Plan: 100% / Map: 100% | Grid: 1'-0\" ● Online"
```
