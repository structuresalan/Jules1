...
- Location: tests\visual-workspace-tools.spec.ts:75:3
...
Call log:
  - waiting for getByTestId('annotation-1')
    - locator resolved to <g data-selected="true" data-tool-type="Cloud" class="cursor-pointer" data-testid="annotation-1">…</g>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <rect width="980" height="640" fill="url(#paper)"></rect> intercepts pointer events
