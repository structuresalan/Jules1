...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Callout is pressable without crashing
...
- generic [ref=e1]:
      ...
      - generic [ref=e70]:
        - generic [ref=e71]:
          ...
          - button "Box" [ref=e84] [cursor=pointer]:
            - img [ref=e85]
            - generic [ref=e87]: Box
          - button "Callout" [active] [ref=e88] [cursor=pointer]:
            - img [ref=e89]
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Callout tool active. Use the board canvas to place or edit this markup.
