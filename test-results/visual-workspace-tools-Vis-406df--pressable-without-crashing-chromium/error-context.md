...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button More is pressable without crashing
...
- generic [ref=e1]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e193]:
        - generic [ref=e194]:
          ...
          - button "More" [active] [ref=e205] [cursor=pointer]:
            - img [ref=e206]
  ...
  - generic [ref=e930]:
    - generic [ref=e931]:
      - generic [ref=e932]:
        - generic [ref=e933]: Workspace Settings
        - heading "Workspace settings" [level=2] [ref=e934]
      - button [ref=e935] [cursor=pointer]:
        - img [ref=e936]
    - generic [ref=e940]:
      - generic [ref=e941]:
        - generic [ref=e942]: Current role
        - paragraph [ref=e943]: Engineer can edit everything. Client can comment only.
        - combobox [ref=e944]:
          - option "Engineer" [selected]
          - option "Client"
      - generic [ref=e945]:
        - button "Attach Demo Photo" [ref=e946] [cursor=pointer]
        - button "Attach Demo Document" [ref=e947] [cursor=pointer]
        - button "Reset Demo Data" [ref=e948] [cursor=pointer]
        - button "Close" [ref=e949] [cursor=pointer]
  - contentinfo [ref=e950]:
    - generic [ref=e951]: More tool active. Use the board canvas to place or edit this markup.
    - generic [ref=e952]: "X: 152'-3 1/2\" Y: 47'-6 3/4\" | Plan: 100% / Map: 100% | Grid: 1'-0\" ● Online"
```
