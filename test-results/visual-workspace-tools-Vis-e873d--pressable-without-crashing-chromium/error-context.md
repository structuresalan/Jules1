...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Note is pressable without crashing
...
- generic [ref=e1]:
  - banner [ref=e2]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e120]:
        - generic [ref=e121]:
          - button "Note" [active] [ref=e122] [cursor=pointer]:
            - img [ref=e123]
  ...
  - generic [ref=e930]:
    - generic [ref=e931]:
      - generic [ref=e932]:
        - generic [ref=e933]: Add Note
        - heading "Add note to selected item" [level=2] [ref=e934]
      - button [ref=e935] [cursor=pointer]:
        - img [ref=e936]
    - generic [ref=e940]:
      - textbox [ref=e941]: Seat angle connection shows heavy rust and section loss. Verify seat and bearing stiffener condition.
      - button "Save Note" [ref=e942] [cursor=pointer]
  - contentinfo [ref=e943]:
    - generic [ref=e944]: Note tool active. Use the board canvas to place or edit this markup.
