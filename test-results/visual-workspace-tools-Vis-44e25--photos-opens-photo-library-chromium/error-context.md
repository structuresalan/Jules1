...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace toolbar behavior >> View all photos opens photo library
- Location: tests\visual-workspace-tools.spec.ts:151:3
