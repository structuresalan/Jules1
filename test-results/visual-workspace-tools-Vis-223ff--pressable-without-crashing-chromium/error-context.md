...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Distance is pressable without crashing
...
- generic [ref=e1]:
  - banner [ref=e2]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e101]:
        - generic [ref=e102]:
          - button "Distance" [active] [ref=e103] [cursor=pointer]:
            - img [ref=e104]
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Distance tool active. Pick points on the board to record measurement markup.
