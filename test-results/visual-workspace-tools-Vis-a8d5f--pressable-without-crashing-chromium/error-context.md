...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Layers is pressable without crashing
...
- generic [ref=e1]:
  - banner [ref=e2]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e167]:
        - generic [ref=e168]:
          - button "Layers" [active] [ref=e169] [cursor=pointer]:
            - img [ref=e170]
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Layers tool active. Use the board canvas to place or edit this markup.
