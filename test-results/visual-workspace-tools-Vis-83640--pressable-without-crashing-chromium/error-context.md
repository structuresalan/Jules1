...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> workspace button Review is pressable without crashing
  ...
  - banner [ref=e2]:
    - generic [ref=e3]:
      ...
      - navigation [ref=e11]:
        ...
        - button "Review" [active] [ref=e13] [cursor=pointer]
