...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Eraser is pressable without crashing
...
- generic [ref=e1]:
  ...
  - contentinfo [ref=e933]:
    - generic [ref=e934]: Eraser active. Click the annotation you want erased. Press Esc for Select.
