...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace toolbar behavior >> Distance requires scale first
- Location: tests\visual-workspace-tools.spec.ts:156:3
