...
- Name: visual-workspace-tools.spec.ts >> Visual Workspace pressable control coverage >> toolbar button Link is pressable without crashing
...
- generic [ref=e1]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e120]:
        - generic [ref=e121]:
          ...
          - button "Link" [active] [ref=e137] [cursor=pointer]:
            - img [ref=e138]
  ...
  - contentinfo [ref=e929]:
    - generic [ref=e930]: Link tool active. Select a plan marker, photo, cost, or document to connect it to the item.
